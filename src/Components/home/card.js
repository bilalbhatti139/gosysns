      ...
      <div className="max-w-screen-lg  mx-0 sm:mx-0 md:mx-auto">
        <div className="grid grid-cols-4  bg-[#091E2E] shadow-md gap-4 rounded-2xl px-4 py-8">
          <div className="border-r-2 border-primary py-4 flex items-center flex-col">
            ...
            <h2 className="text-[26px]  font-semibold text-[#fff]">
              RootServer
            </h2>
            <p className="text-[#89939B] text-base">
              Lorem Ipsum is simply dummy text of the printing and typesetting
              industry.
            </p>
            <span className="text-md mt-4 font-semibold text-[#fff]">
              Root Server
          ...
          <div className="border-r-2 border-primary py-4 flex items-center flex-col">
            ...
            <h2 className="text-[26px]  font-bold text-[#fff]">Gameserver</h2>
            <p className="text-[#89939B] text-md">
              Lorem Ipsum is simply dummy text of the printing and typesetting
              industry.
            </p>
            <span className="text-md mt-4 font-semibold text-[#fff]">
          ...
          <div className="border-r-2 border-primary py-4 flex items-center flex-col">
            <BiSolidServer className="text-primary text-5xl" />
            <h2 className="text-[26px]  font-bold text-[#fff]">
              Dedicated Server
            </h2>
            <p className="text-[#89939B] text-md">
              Lorem Ipsum is simply dummy text of the printing and typesetting
          ...
          <div className="  py-4 flex items-center flex-col">
            <FaGamepad className="text-primary text-5xl" />
            <h2 className="text-[26px]  font-bold text-[#fff]">Domains</h2>
            <p className="text-[#89939B] text-md">
              Lorem Ipsum is simply dummy text of the printing and typesetting
              industry.
            </p>
